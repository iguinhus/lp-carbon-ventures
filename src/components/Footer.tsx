...
export function Footer() {
  return (
    <footer className="relative bg-carbon px-6 py-12">
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-col items-center justify-between gap-6 md:flex-row">
          ...
          <p className="text-center text-sm text-white/60">
            {SITE_COPY.footer.text}
          </p>

          {/* Social/Links */}
          <div className="flex items-center gap-4">
            <a
              href="https://wa.me/5511953420103"
              target="_blank"
        ...
        <div className="mt-8 border-t border-white/10 pt-8 text-center text-xs text-white/40">
          &copy; {new Date().getFullYear()} Carbon Ventures. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
